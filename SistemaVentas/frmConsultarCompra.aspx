               ...
               <div class="card">
                  ...
                  <div class="card-body p-2">
                        <div class="row">
                            ...
                            <div class="col-sm-2">
                              <div class="form-group mb-0">
                                <label for="txtNitProveedor" class="col-form-label col-form-label-sm">Proveedor:</label>
                            ...
                            <div class="col-sm-2">
                              <div class="form-group mb-0">
                                <label for="txtNitProveedor" class="col-form-label col-form-label-sm">Tienda:</label>
