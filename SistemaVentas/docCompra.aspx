            ...
            <tr>
                <td colspan="6">
                    <table style="width: 100%;">
                        ...
                        <tr>
                            <td width="15">Nit:</td>
                            <td style="border-bottom: 1px solid black;"><center><span id="nitproveedor"></span></center></td>
            ...
            <tr>
                <td colspan="6">
                    <table style="width: 100%;" border="0">
                        ...
                        <tr>
                            <td width="15">Nit:</td>
                            <td style="border-bottom: 1px solid black;"><center><span id="nittienda"></span></center></td>
            ...
            AjaxPost("../frmConsultarCompra.aspx/ObtenerDetalle", JSON.stringify(request),
                function (response) {
                    ...
                    if (response.estado) {
                        ...
                        $("#nitproveedor").text(response.objeto.oProveedor.Nit);
                        $("#nombreproveedor").text(response.objeto.oProveedor.RazonSocial);

                        $("#nittienda").text(response.objeto.oTienda.NIT);
