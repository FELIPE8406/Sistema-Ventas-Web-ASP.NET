                                      ...
                                      <div class="row">
                                          ...
                                          <div class="col-sm-4">
                                            <div class="form-group mb-0">
                                              <label for="txtNitProveedor" class="col-form-label col-form-label-sm">NIT:</label>
                                              <input type="text" class="form-control form-control-sm model" readonly id="txtNitProveedor" name="NIT">
                                            </div>
                                          </div>
                                          <div class="col-sm-4">
                                            <div class="form-group mb-0">
                                      ...
                                      <div class="row">
                                          ...
                                          <div class="col-sm-4">
                                            <div class="form-group mb-0">
                                              ...
                                              <input type="text" class="form-control form-control-sm model" readonly id="txtNitTienda" name="NIT">
                                            </div>
                                          </div>
                                          <div class="col-sm-4">
                                            <div class="form-group mb-0">
