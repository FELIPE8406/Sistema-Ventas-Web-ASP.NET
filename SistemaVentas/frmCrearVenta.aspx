                                      ...
                                      <div class="row collapse" id="collapse1">
                                          ...
                                          <div class="col-sm-4">
                                            <div class="form-group mb-0">
                                              ...
                                              <label class="form-control form-control-sm model mb-1" readonly id="lbltiendanit" ></label>
                                            </div>
                                          </div>
                                          <div class="col-sm-4">
                                            <div class="form-group mb-0">
                                ...
                                <div class="card" style="background-color: #F7F7F7">
                                  <div class="card-body p-2">
                                      ...
                                      <div class="row collapse" id="collapse2">
                                          ...
                                          <div class="col-sm-4">
                                            <div class="form-group mb-0">
                                              <label for="txtNitProveedor" class="col-form-label col-form-label-sm">Nombre:</label>
